...
> 📍 **Roadmap Context**: This guide covers pilot deployment for the **Phase 2: Full System** stage (Months 13–18) of the [24-month Smart Plug AI roadmap](ROADMAP.md). See [WEEK3_BACKEND_INTEGRATION.md](WEEK3_BACKEND_INTEGRATION.md) for backend and monitoring setup.
